...
For GUI the application uses **Swing** and **Java 2D Graphics**.

Current visualization is 2D only.

**[Aparapi](https://aparapi.com/)** library is used for GPU computations.

The application introduces an abstraction for numbers
...
<b><span style='color:#644a9b;'>{</span></b>
    <span style='color:#0057ae;'>&quot;properties&quot;</span><b><span style='color:#644a9b;'>:{</span></b>
        ...
        <span style='color:#bf0303;'>&quot;bounceFromWalls&quot;</span><span style='color:#bf0303;'>:</span> <b>false</b><b><span style='color:#644a9b;'>,</span></b>                     <span style='color:#bf0303;'>#</span> <span style='color:#bf0303;'>If</span> <span style='color:#bf0303;'>true</span><b><span style='color:#644a9b;'>,</span></b> <span style='color:#bf0303;'>objects</span> <span style='color:#bf0303;'>will</span> <span style='color:#bf0303;'>bounce</span> <span style='color:#bf0303;'>from</span> <span style='color:#bf0303;'>the</span> <span style='color:#bf0303;'>screen</span> <span style='color:#bf0303;'>walls.</span>
...
There is **Number** interface which almost interely copies the BigDecimal methods.
