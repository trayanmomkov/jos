...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // NumberFactory.number = new NumberDoubleImpl(0);

        long[] times = new long[10];
        for (int j = 0; j < times.length; j++) {
            n1 = NumberFactory.createNumber(3.4);
            n2 = NumberFactory.createNumber(3.5);
            long startTime = System.nanoTime();
            for (int i = 0; i < N; i++) {
                calculate();
                // n1 = n1.multiply(n2);
                // n1 = n1.divide(NumberFactory.createNumber(10));
            }
